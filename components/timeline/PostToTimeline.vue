<template>
  <v-container>
    ...
    <div
      v-if="post==false"
      class="pl-3 display-flex">
      <p class="font12">View by Date</p>
      <v-icon style="font-size: 15px; margin-bottom: 15px;">arrow_drop_down</v-icon>
        ...
        <v-card-title primary-title>
          <v-flex sm12>
            <div class="stepper-date">
              ...
              <v-divider />
              <v-icon color="deep-purple lighten-1">business</v-icon>
